...
const translations: Record<Language, Record<string, string>> = {
  EN: {
    ...
    footer_about: 'About',
    about_title: 'ABOUT LOGICFLOW',
    about_subtitle: 'Built by a student, for students.',
    about_intro_title: 'What is LogicFlow?',
    about_intro_content: 'LogicFlow is a DSE Mathematics AI tool built specifically for high school students. It aims to bridge the gap between general AI and the strict HKEAA marking requirements.',
    about_story_title: 'Our Story',
    about_story_content: 'This project started when a DSE student got frustrated with messy second-hand textbooks and AI models that couldn\'t follow marking schemes. Driven by a need for cleaner revision tools, she built this platform in just 4 days during her study break.',
    about_mission_title: 'Our Mission',
    about_mission_content: 'To make quality DSE math revision resources accessible, organized, and stress-free for every student fighting for their future.',
    about_contact_title: 'Contact Us',
    about_contact_content: 'Follow us on Instagram or Xiaohongshu: @LogicFlow.hk. We would love to hear your feedback!',
  ...
  ZH: {
    ...
    footer_privacy: '私隱政策',
    footer_about: '關於我們',
    about_title: '關於 LOGICFLOW',
    about_subtitle: '由學生建立，為學生服務。',
    about_intro_title: 'LogicFlow 是什麼？',
    about_intro_content: 'LogicFlow 是一個專為高中生設計的 DSE 數學 AI 工具。我們致力於填補通用 AI 與考評局嚴格評分準則之間的鴻溝。',
    about_story_title: '我們的故事',
    about_story_content: '這個項目的初衷始於一位 DSE 學生對凌亂的二手課本以及無法遵循評分標準的 AI 模型感到沮喪。為了擁有更整潔的複習工具，她在四天的假期中獨自建立了這個平台。',
    about_mission_title: '我們的使命',
    about_mission_content: '讓每位為未來奮鬥的學生都能獲得優質、有條理且輕鬆的 DSE 數學複習資源。',
    about_contact_title: '聯絡我們',
    about_contact_content: '在 Instagram 或小紅書關注我們：@LogicFlow.hk。我們非常期待聽到你的反饋！',
